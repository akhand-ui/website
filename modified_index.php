...
<body>
   ...
   <?php include("include/header.php");?>
	...
	div class="container-fluid p-0 pb-5 mb-5">
        ...
        <video autoplay muted loop class="position-relative">
            <source src="img/1733834004809662.mp4" type="video/mp4">
    ...
    <div class="container-fluid p-0 pb-5 mb-5">
        <div id="header-carousel" class="carousel slide carousel-fade" data-ride="carousel">
           ...
           <!-- <div class="video-banner">
			...
			<div class="carousel-inner" style="background:url('img/banner.webp');">
                <div class="carousel-homepage col-md-8">
                ...
                <div class="carousel-item active" style="min-height: 500px;">
                    ...
                    <div class="carousel-caption d-flex align-items-center justify-content-center">
                        <div class="p-5" style="width: 100%; max-width: 900px;">
                            <h2 class="text-white  font-weight-semi-bold mt-2" style="font-size: 20px;">ABOUT US</h2>
...
<p>University applicationSecuring internships</p>

                            <a href="servicrs.php" class="btn btn-primary py-md-2 px-md-4 font-weight-semi-bold mt-2">Learn More</a>
                        </div>
                    </div>
                </div>
                <div class="carousel-item" style="min-height: 500px;">
        ...
        <div class="container py-5 about-us">
            <div class="row align-items-center">
                ...
                <div class="col-lg-7">
                    ...
                    <a href="about.php" class="btn btn-primary py-md-2 px-md-4 font-weight-semi-bold mt-2">Read More</a>
                </div>
            </div>
        </div>
    </div> 
